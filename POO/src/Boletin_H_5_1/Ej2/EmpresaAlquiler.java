...
public class EmpresaAlquiler {
	...
	public boolean altaVehiculo() throws InvalidValueException {
		// Representa el veh�culo que ser� dado de alta
		Vehiculo v = null;
		...
		while (!respuestaCorrecta) {
			System.out.println("�Qu� veh�culo quieres introducir: Coche, Microbus o Furgoneta?");
		...
		while (!respuestaCorrecta) {
			...
			// TODO: comprobar validez matr�cula
		...
		while (!respuestaCorrecta) {
			System.out.print("�Qu� tipo de gama quiere?: ");
		...
		respuestaCorrecta = false;
		while (!respuestaCorrecta) {
			System.out.print("�Qu� tipo de combustible quiere?: ");
...
//			}
		...
		/*
		 * Voy a coger los datos espec�ficos de cada veh�culo
		 */
		switch (tipoVehiculo) {
		case "coche":
