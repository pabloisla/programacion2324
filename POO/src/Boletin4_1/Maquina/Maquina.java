...
public class Maquina {
	...
	private void setDosisCafe(int dosis) throws ParametroNoValidoException{
		...
		if (dosis <= 0 || dosis > MAX_CAFE) {
			throw new ParametroNoValidoException("No puedo poner dicha cantidad de dosis de caf�");
		}
	...
	public String toString() {
		String cad = "Estado de la m�quina:"
				+ "\nCaf�s Restantes: " + this.dosisCafes
				+ "\nDosis de leche restantes: " + this.dosisLeche
				+ "\nVasos restantes: " + this.vasosRestantes
				+ "\nRecaudaci�n: " + this.monedero;
		
		return cad;
	}
	
	public String mostrarMenu() {
		return "1. Caf� solo (" + PRECIO_CAFE + " �)"
				+ "\n2. Leche (" + PRECIO_LECHE + " �)"
				+ "\n3. Caf� con leche (" + PRECIO_CAFE_LECHE + " �)"
				+ "\n4. Conocer estado de la m�quina"
